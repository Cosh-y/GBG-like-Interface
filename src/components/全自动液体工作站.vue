...
<template>
      <Vue3DraggableResizable
        ...
        @click="ValueChange"
        >
        <Image src="https://s1.ax1x.com/2023/03/18/ppJOqEQ.png" fit="contain" width="100px" height="100px" alt="cover" />
        <Paragraph class="ivu-text-center" type="danger">全自动液体工作站</Paragraph>
      </Vue3DraggableResizable>
