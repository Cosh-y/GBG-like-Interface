...
<template>
    <Vue3DraggableResizable
        ...
        @click="ValueChange"
        >
        <Image src="https://s1.ax1x.com/2023/03/18/ppJLIw4.png" fit="contain" width="100px" height="100px" alt="cover" />
        <Paragraph class="ivu-text-center" type="danger">机械手</Paragraph>
    </Vue3DraggableResizable>
    <Drawer title="设备介绍" :closable="false" v-model="Value">
        ...
        <h3>IP Address</h3>
        <Input v-model="ip" placeholder="Enter something..." style="width: 200px" />
    </Drawer>
</template>